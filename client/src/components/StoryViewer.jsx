...
const StoryViewer = ({viewStory, setViewStory}) => {
  ...
  return (
    ...
    {/*User Info - top left */}
    <div className='absolute top-4 left-4 flex items-center space-x-3 p-2 px-4 sm:p-4 sm:px-8 backdrop-blur-2xl rounder bg-black/50'>
    <img src={viewStory.user?.profile_picture} alt='' className='w-7 h-7 sm:w-8 sm:h-8 rounded-full object-cover border border-white' />
     <div className='text-white font-medium flex items-center gap-1.5'>
       ...
       {/*Close Button */}
       <button onClick={handleClose} className='absolute top-4 right-4 text-white text-3xl font-bold focuse:outline-none'>
